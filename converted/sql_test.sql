...
aggregated_orders AS (
  ...
  LEFT JOIN recent_revenue_30 r30 ON co.customer_id = r30.customer_id
  LEFT JOIN recent_revenue_90 r90 ON co.customer_id = r90.customer_id
),
...
merged_data AS (
  ...
  LEFT JOIN rfm_scores rfm ON cc.customer_id = rfm.customer_id
